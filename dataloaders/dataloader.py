...
class Dataset:
    ...
    def get_item(self, idx):
        ...
        return ts_inc, adj_his, adj_ctx, adj_tgt, tgt_u, tgt_i, tgt_u_neg, tgt_i_neg
...
class Dataloader:
    ...
    def _get_iter(self, start_idx=0):
        ...
        for i in range(start_idx, len(self.ds)):
            ts_inc, adj_his_inc, adj_ctx, adj_tgt, tgt_u, tgt_i, tgt_u_neg, tgt_i_neg = self.ds.get_item(i)
